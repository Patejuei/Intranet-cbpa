...
<head>
  ...
  <title>Acta de Entrega #{{ $certificate->id }}</title>
  <style>
    body {
...
<body>
  <div class="header">
    ...
    <h2>ACTA DE ENTREGA DE MATERIAL MENOR</h2>
  </div>
  ...
  <table class="info-table">
    ...
    <tr>
      <td><strong>Bombero Receptor:</strong></td>
      <td>{{ $certificate->firefighter->full_name }}</td>
    </tr>
    <tr>
      <td><strong>Oficial a Cargo:</strong></td>

                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Historial de recepción de materiales devueltos por
                            bomberos.
                        </p>
                    </div>

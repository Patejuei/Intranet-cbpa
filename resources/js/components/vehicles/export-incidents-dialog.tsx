...
interface ExportIncidentsDialogProps {
    open: boolean;
...
export function ExportIncidentsDialog({
    open,
    onOpenChange,
    vehicles,
}: ExportIncidentsDialogProps) {
    ...
    const handleExport = (exportAll = false) => {
        ...
        window.location.href = `/vehicles/reports/incidents?${params.toString()}`;
        onOpenChange(false);
    };
            ...
            <DialogContent className="sm:max-w-[560px]">
                <DialogHeader>
                    <div className="flex items-center gap-2">
                        ...
                        <DialogTitle>Exportar Incidencias a Excel</DialogTitle>
                    </div>
                    <DialogDescription>
                        Seleccione los vehículos y el periodo temporal para generar el reporte de incidencias en formato Excel (.xlsx).
                    </DialogDescription>
                </DialogHeader>
